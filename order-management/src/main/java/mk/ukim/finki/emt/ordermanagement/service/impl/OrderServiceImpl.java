...
import mk.ukim.finki.emt.ordermanagement.domain.valueobjects.Datum;
...
public class OrderServiceImpl implements OrderService {
    ...
    private Order toDomainObject(OrderForm orderForm) {
        var order = new Order(new Datum(LocalDate.now()),orderForm.getCurrency(),
                new Address(orderForm.getAddress(), orderForm.getCity(), orderForm.getCountry(), orderForm.getPostalCode()));
